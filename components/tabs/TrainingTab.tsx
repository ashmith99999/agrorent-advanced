      ...
      <div className="frosted-card rounded-2xl p-8 shadow-[var(--app-shadow)]">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {recommendedModules.map(module => (
            <div key={module.id} className="bg-purple-500/10 backdrop-blur-sm rounded-2xl p-6 border border-purple-200/50 hover:shadow-lg transition-all">
      ...
      <div className="frosted-card rounded-2xl p-8 shadow-[var(--app-shadow)]">
        ...
        <div className="space-y-4">
          {TRAINING_MODULES.map(module => (
            <div key={module.id} className="frosted-subtle rounded-xl p-4 flex items-center gap-4">
                <div className="text-4xl">{module.icon}</div>
                <div className='flex-1'>
